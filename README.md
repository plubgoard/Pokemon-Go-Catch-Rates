...
On the other hand, Github is not something that I am very familiar with. I learned a lot in trying to create a Repository for this project, which I had only done once previously. To be quite honest, I originally uploaded files from my computer directly to Github instead of pushing to Github using Git.
