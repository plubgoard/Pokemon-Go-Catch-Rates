...
On the other hand, Github is not something that I am very familiar with. I learned a lot in trying to create a Repository for this project, which I had only done once previously. I learned how to create a README file, and how to commit changes to Github. To be completely honest, I initially simply uploaded files to the Github website instead of pushing to Git itself.
